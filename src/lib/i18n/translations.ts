...
const ru = {
  ...
  health: {
    ...
    panelNote: 'Проверки обновляются вместе с данными дашборда каждые 30 секунд.',
    items: {
      website: 'Сайт',
      qr: 'QR-система',
    ...
    descriptions: {
      website: 'Доступность цели перенаправления',
      qr: 'Запись сканирований и аналитический конвейер',
      database: 'Подключение Postgres для чтения/записи',
      backoffice: 'Панель и слой аутентификации',
      geo: 'Определение страны по IP-заголовкам',
    },
  },
  range: {
    '24h': '24 часа',
